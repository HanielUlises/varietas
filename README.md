...
Still to come: the tangent half-angle rationalisation and the saturation by $\prod_i(1+t_i^2)$ that removes the components at infinity, then the URDF front end, code emission, workspace implicitization and the decomposition of the singular locus.
