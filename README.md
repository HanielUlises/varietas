...
Still to come: the URDF front end, the tangent half-angle rationalisation, code emission, workspace implicitization and the decomposition of the singular locus.
