...
Still to come: the tangent half-angle rationalisation that produces those ideals, then code emission, workspace implicitization and the decomposition of the singular locus.
