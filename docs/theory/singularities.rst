...
Rank is not a polynomial condition, and not even a continuous function of the
...
singularity, since its tool is at distance :math:`2+\cos q_2` from the first
axis and that never vanishes, yet its singular ideal is not the unit ideal,
because over
